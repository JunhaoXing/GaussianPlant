...
def build_sam3_image_model(
    ...
    # Set the default CUDA device before building so that any hardcoded
    # device="cuda" calls (e.g. in PositionEmbeddingSine precompute) resolve
    # to the correct GPU rather than always defaulting to cuda:0.
